    ...
    <main class="flex justify-center items-center min-h-screen bg-white">
        <div class="max-w-4xl mx-auto p-8 flex space-x-12">
            <div class="relative w-1/2">
                ...
                <img src="image/about.png" alt="Fresh green leaves signifying growth and rejuvenation on a light background" class="relative z-10" />
            </div>
            <div class="w-1/2 flex flex-col justify-center space-y-6">
                <h1 class="text-3xl font-bold text-gray-800 leading-tight">
                    CIVICHUB:Municipal Management Services Suite
                </h1>
                <p class="text-gray-600 leading-relaxed">
                    A initiative by students for the public and society.CivicHub is a comprehensive, integrated software solution designed to streamline and enhance the administration and operational efficiency of municipal government.The Municipal Management Services Suite
                    empowers municipalities to better serve their communities, optimize resource allocation, and ensure transparency and accountability in their operations.
                </p>
