...
<head>
    ...
    <title>CIVICHB:Contact Us</title>
...
<body class="font-roboto bg-gray-100 text-gray-800">
    <header class="flex justify-between items-top p-6">
        ...
        <nav class="flex space-x-6">
            ...
            <a href="admin login.php" class="text-gray-700 hover:text-gray-900">Admin Login</a>
        </nav>
    </header>
    <div class="flex">
        <img src="image/about.png" alt="A branch with green leaves on a white background">
        <div class="ml-10">
            <button class="bg-green-600 text-white font-bold px-6 py-2 rounded-full mb-6">
                CONTACT US
            </button>
            <div class="flex items-center mb-4 text-lg text-gray-700">
